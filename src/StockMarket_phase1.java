...
public class StockMarket_phase1 {
	...
	public static class Map1 extends Mapper<LongWritable, Text, Text, Text> {
		...
		public void map(LongWritable key, Text value, Context context)
			...
			/* A line of data: "2014-12-31,1.58,1.66,1.50,1.58,236500,1.58" */
			...
			if (line.indexOf('-') >= 0) {
				...
				/* How a (key, value) pair will look: 
				 * ("ANTH-2014-12", "2014-12-31,1.58,1.66,1.50,1.58,236500,1.58") */
	...
	public static class Reduce1 extends Reducer<Text, Text, Text, Text> {
		...
		public void reduce(Text key, Iterable<Text> values, Context context)
			...
			/* How an input (key, value) pair will look: 
			 * ("ANTH-2014-12", "2014-12-31,1.58,1.66,1.50,1.58,236500,1.58") */
			...
			for (Text value : values) {
				...
				String line = value.toString();
				String date = line.substring(0, line.indexOf(','));
				String dayOfTheMonth = date.substring(date.lastIndexOf('-')+1, date.length());
			 ...
			 * Calculate xi */
			double adjBegin = Double.parseDouble(firstDayData.substring(firstDayData.lastIndexOf(',')+1));
			double adjEnd = Double.parseDouble(lastDayData.substring(lastDayData.lastIndexOf(',')+1));
			
			/* Apply the formula for xi */
			double xi = (adjEnd - adjBegin)/adjBegin;
			
			/* Set the string as the same thing we received "STOCKNAME-MONTH-YEAR" */
